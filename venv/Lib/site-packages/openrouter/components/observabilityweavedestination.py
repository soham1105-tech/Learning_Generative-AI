...
class ObservabilityWeaveDestinationConfigTypedDict(TypedDict):
    api_key: str
    entity: str
    project: str
...
class ObservabilityWeaveDestinationConfig(BaseModel):
...
ObservabilityWeaveDestinationType = Literal["weave",]


class ObservabilityWeaveDestinationTypedDict(TypedDict):
    ...
    config: ObservabilityWeaveDestinationConfigTypedDict
    created_at: str
    ...
    type: ObservabilityWeaveDestinationType
    updated_at: str
...
class ObservabilityWeaveDestination(BaseModel):
    api_key_hashes: Nullable[List[str]]
    r"""Optional allowlist of OpenRouter API key hashes (`api_keys.hash`) whose traffic is forwarded to this destination. `null` means all keys."""
...
try:
    ObservabilityWeaveDestinationConfig.model_rebuild()
except NameError:
    pass
