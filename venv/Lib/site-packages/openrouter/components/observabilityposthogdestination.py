...
class ObservabilityPosthogDestinationConfigTypedDict(TypedDict):
    api_key: str
...
class ObservabilityPosthogDestinationConfig(BaseModel):
    api_key: Annotated[str, pydantic.Field(alias="apiKey")]

    endpoint: Optional[str] = "https://us.i.posthog.com"
    ...
    def serialize_model(self, handler):
        optional_fields = set(["endpoint", "headers"])
...
ObservabilityPosthogDestinationType = Literal["posthog",]


class ObservabilityPosthogDestinationTypedDict(TypedDict):
    ...
    config: ObservabilityPosthogDestinationConfigTypedDict
    created_at: str
    ...
    type: ObservabilityPosthogDestinationType
    updated_at: str
...
class ObservabilityPosthogDestination(BaseModel):
    api_key_hashes: Nullable[List[str]]
    r"""Optional allowlist of OpenRouter API key hashes (`api_keys.hash`) whose traffic is forwarded to this destination. `null` means all keys."""
...
try:
    ObservabilityPosthogDestinationConfig.model_rebuild()
except NameError:
    pass
