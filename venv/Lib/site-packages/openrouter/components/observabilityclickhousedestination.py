...
class ObservabilityClickhouseDestinationConfig(BaseModel):
    database: str
...
ObservabilityClickhouseDestinationType = Literal["clickhouse",]
...
class ObservabilityClickhouseDestinationTypedDict(TypedDict):
    ...
    type: ObservabilityClickhouseDestinationType
    updated_at: str
