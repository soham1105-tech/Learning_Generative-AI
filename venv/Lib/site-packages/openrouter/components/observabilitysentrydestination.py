...
class ObservabilitySentryDestinationConfigTypedDict(TypedDict):
    dsn: str
    otlp_endpoint: str
...
class ObservabilitySentryDestinationConfig(BaseModel):
    dsn: str

    otlp_endpoint: Annotated[str, pydantic.Field(alias="otlpEndpoint")]
...
ObservabilitySentryDestinationType = Literal["sentry",]


class ObservabilitySentryDestinationTypedDict(TypedDict):
    ...
    config: ObservabilitySentryDestinationConfigTypedDict
    created_at: str
    ...
    type: ObservabilitySentryDestinationType
    updated_at: str
...
class ObservabilitySentryDestination(BaseModel):
    api_key_hashes: Nullable[List[str]]
    r"""Optional allowlist of OpenRouter API key hashes (`api_keys.hash`) whose traffic is forwarded to this destination. `null` means all keys."""
...
try:
    ObservabilitySentryDestinationConfig.model_rebuild()
except NameError:
    pass
